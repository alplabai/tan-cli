- **`MANIFEST.md` stated two different vendor points and nothing compared
  ...
  tan-cli#714 moved the tree to `d00dbdc1`. The pin has moved three times since
  that vendor point (`56dea6b5`, `bd8be484`, then
  `88318e759958529fbbd8fe9d481373681c0fa78d` on `dev` today).
...
- **`MANIFEST.md` claimed alp-sdk#1016 rewrote the `Customer workflow:` header
  in "every example `board.yaml`". It skipped one, and it is one tan vendors.**
