...
* **Portable, chip-free.** Only `<alp/*>` headers -- no chip driver,
  ...
  [`docs/portability.md`](https://github.com/alplabai/alp-sdk/blob/v0.14.0/docs/portability.md)).
...
- [`<alp/hw_info.h>`](https://github.com/alplabai/alp-sdk/blob/v0.14.0/include/alp/hw_info.h) -- SoM/SoC identity surface.
- [`<alp/power.h>`](https://github.com/alplabai/alp-sdk/blob/v0.14.0/include/alp/power.h) -- operating-point profile surface.
- [`<alp/peripheral.h>`](https://github.com/alplabai/alp-sdk/blob/v0.14.0/include/alp/peripheral.h) -- I2C surface.
- [`examples/peripheral-io/i2c-scanner/`](https://github.com/alplabai/alp-sdk/tree/v0.14.0/examples/peripheral-io/i2c-scanner) -- standalone bus-scan companion.
