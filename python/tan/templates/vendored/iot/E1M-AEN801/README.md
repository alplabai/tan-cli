...
cadence -- the whole path on the portable [`<alp/iot.h>`](https://github.com/alplabai/alp-sdk/blob/v0.15.0/include/alp/iot.h)
surface.
...
([`docs/cc3501e-bridge.md`](https://github.com/alplabai/alp-sdk/blob/v0.15.0/docs/cc3501e-bridge.md)),
...
with the [`sensor` template](https://github.com/alplabai/alp-sdk/tree/v0.15.0/examples/peripheral-io/i2c-master) (TMP112
...
- [`<alp/iot.h>`](https://github.com/alplabai/alp-sdk/blob/v0.15.0/include/alp/iot.h) -- Wi-Fi station + MQTT client surface.
- [`docs/cc3501e-bridge.md`](https://github.com/alplabai/alp-sdk/blob/v0.15.0/docs/cc3501e-bridge.md) -- the AEN Wi-Fi transport.
- [`examples/peripheral-io/i2c-master/`](https://github.com/alplabai/alp-sdk/tree/v0.15.0/examples/peripheral-io/i2c-master) -- the `sensor` template, for a real reading to publish.
