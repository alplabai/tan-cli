...
Contrasts with [`examples/peripheral-io/i2c-scanner`](https://github.com/alplabai/alp-sdk/tree/v0.15.0-rc1/examples/peripheral-io/i2c-scanner) -- the
...
V2N-M1 families per
[`metadata/chips/tmp112.yaml`](https://github.com/alplabai/alp-sdk/blob/v0.15.0-rc1/metadata/chips/tmp112.yaml).
...
[`include/alp/chips/tmp112.h`](https://github.com/alplabai/alp-sdk/blob/v0.15.0-rc1/include/alp/chips/tmp112.h)).
...
- [`<alp/chips/tmp112.h>`](https://github.com/alplabai/alp-sdk/blob/v0.15.0-rc1/include/alp/chips/tmp112.h) -- driver API.
- [`examples/peripheral-io/i2c-scanner/`](https://github.com/alplabai/alp-sdk/tree/v0.15.0-rc1/examples/peripheral-io/i2c-scanner) -- discovery companion.
- [`examples/peripheral-io/i2c-slave/`](https://github.com/alplabai/alp-sdk/tree/v0.15.0-rc1/examples/peripheral-io/i2c-slave) -- slave-mode companion, built on the `alp_i2c_target_*` surface.
