...
> `BOARD_I2C_SENSORS` and probing for TMP112 NACKs on real hardware. On
> the E1M-AEN family BRD_I2C is additionally the slave-only Alif LPI2C0
> (ADR 0017), so the SoC can't master it at all. See
