...
[`docs/cross-platform-setup.md`](https://github.com/alplabai/alp-sdk/blob/v0.15.0-rc1/docs/cross-platform-setup.md)
section 7.7.
...
- [`docs/firmware-quickstart.md`](https://github.com/alplabai/alp-sdk/blob/v0.15.0-rc1/docs/firmware-quickstart.md)
  -- single-OS bring-up walk-through.
- [`docs/cross-platform-setup.md`](https://github.com/alplabai/alp-sdk/blob/v0.15.0-rc1/docs/cross-platform-setup.md)
  -- Windows/macOS/Linux toolchain + serial-port notes.
- [`docs/troubleshooting.md`](https://github.com/alplabai/alp-sdk/blob/v0.15.0-rc1/docs/troubleshooting.md)
