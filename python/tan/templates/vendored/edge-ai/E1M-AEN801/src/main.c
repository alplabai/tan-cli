 ...
 * (see alp-sdk's examples/ai/cold-chain-monitor/models/README.md -- not
 * part of this scaffolded project); with no model the deterministic
 * classifier + anomaly fallback run.
 *
 *
 * ── Why the BME280 ────────────────────────────────────────────────────────
 *
