...
# `ref:` and `parity.yml`'s `PINNED_SDK_TAG` are both `722320a1`, which
...
needs_sdk_vela_profile = pytest.mark.skipif(
    ...
    reason=(
        ...
        "722320a1; once that pin moves this test RUNS, and a failure here "
...
needs_sdk_npu_op_tables = pytest.mark.skipif(
    ...
    reason=(
        ...
        "parity.yml's PINNED_SDK_TAG sit at 722320a1; once that pin moves "
...
needs_sdk_after_the_model_engine_relocation = pytest.mark.skipif(
    ...
    reason=(
        ...
        "sdk_parity `ref:` and parity.yml's PINNED_SDK_TAG sit at 722320a1; "
...
needs_sdk_model_perf_fixture = pytest.mark.skipif(
    ...
    reason=(
        ...
        "PINNED_SDK_TAG sit at 722320a1; once that pin moves this test RUNS, "
