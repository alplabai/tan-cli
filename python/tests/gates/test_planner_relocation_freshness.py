...
#: Upstream commits in range touching this table's files:
#:   (none)
#: AUTOMATED RE-SYNC (mirror / PINNED_HASHES): `ff27f179` -> `b9fbc553`, proposed by
...
PINNED_SDK_COMMIT = "b9fbc5531c2923e097641c337bae655f79366a12"  # alp-sdk, past 0914da38 -- see above
