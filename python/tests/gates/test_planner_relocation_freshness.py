...
#: Upstream commits in range touching this table's files:
#:   (none)
#: AUTOMATED RE-SYNC (mirror / PINNED_HASHES): `ff27f179` -> `d840670f`, proposed by
...
PINNED_SDK_COMMIT = "d840670f3abef30fa9bdb725155ee5b0c1f908ce"  # alp-sdk, past 0914da38 -- see above
