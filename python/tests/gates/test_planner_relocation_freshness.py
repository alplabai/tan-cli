...
#: AUTOMATED RE-SYNC (mirror / PINNED_HASHES): `722320a1` -> `3c929974`, proposed by
...
PINNED_SDK_COMMIT = "3c9299744ee52424c831cc9c4cd7f6c8f1fb9b9f"  # alp-sdk, 63 commits past v0.16.0, untagged -- see above
...
#: AUTOMATED RE-SYNC (hand-port / HAND_PORT_HASHES): `722320a1` -> `3c929974`, proposed by
#: `python/scripts/planner_resync.py`. THIS BLOCK IS MACHINE-WRITTEN and
#: records only WHAT moved -- it makes no claim about behaviour, and no
#: claim that anything was audited. Replace it with the audited narrative
#: (which of the commits below are behavioural, what was ported, what was
...
#: Upstream commits in range touching this table's files:
#:   (none)
HAND_PORT_PINNED_SDK_COMMIT = "3c9299744ee52424c831cc9c4cd7f6c8f1fb9b9f"  # alp-sdk, 63 commits past v0.16.0, untagged -- see above (tan-cli#996 closes tan-cli#913)
