...
#: Upstream commits in range touching this table's files:
#:   (none)
#: AUTOMATED RE-SYNC (mirror / PINNED_HASHES): `ff27f179` -> `e296881f`, proposed by
...
PINNED_SDK_COMMIT = "e296881ff12d50e347eec623cfb31798499f8d7d"  # alp-sdk, past 0914da38 -- see above
